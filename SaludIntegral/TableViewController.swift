...
//  SaludIntegral
//
//  Created by LIZZIE M. CANAMAR on 5/2/18.
//  Copyright © 2018 SaludIntegral. All rights reserved.
//

import UIKit

protocol protocoloDiasSemana {
    func ponerDias(diasSeleccionados : [Bool]) -> Void
}
class TableViewController: UITableViewController {
    ...
    var semana = [Bool]()
    var delegado : protocoloDiasSemana!
    override func viewDidLoad() {
        super.viewDidLoad()
        diasSeleccionados = semana
